 ...
 */
@TargetApi(18)
public class ExtractDecodeEditEncodeMuxTestSync {
...
//    }
    ...
    private static class TestWrapper implements Runnable {
        ...
        private ExtractDecodeEditEncodeMuxTestSync mTest;
        private TestWrapper(ExtractDecodeEditEncodeMuxTestSync test) {
            mTest = test;
        }
        @Override
        public void run() {
         ...
         * Entry point.
         */
        public static void runTest(ExtractDecodeEditEncodeMuxTestSync test) throws Throwable {
            test.setOutputFile();
